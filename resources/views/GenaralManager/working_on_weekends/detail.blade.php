                        ...
                        <tr>
                            ...
                            <td>
                                <select name="pushApp" id="pushApp">
                                    <option value="0" @if ($work->approved == false) selected @endif>Pending
                                    </option>
                                    <option value="1" @if ($work->approved == true) selected @endif>Yes
                                    </option>
                                    <option value="2" @if ($work->approved == '2') selected @endif>No</option>
                                </select>
                            </td>
                        </tr>
                    @endforeach
